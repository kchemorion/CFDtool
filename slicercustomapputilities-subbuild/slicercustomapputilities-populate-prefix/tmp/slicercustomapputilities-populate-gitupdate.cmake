...
execute_process(
  COMMAND "/usr/bin/git" --git-dir=.git show-ref "1d984a2c9143e2617ff1ffa9d86c51e07dc6321e"
  WORKING_DIRECTORY "/home/blvksh33p/Desktop/CFDtool/CFDtool/SlicerCustomAppUtilities"
...
elseif(show_ref_output MATCHES "^[a-z0-9]+[ \\t]+refs/heads/")
  ...
  elseif(tag_sha STREQUAL "")
    ...
    if(NOT can_fetch)
      message(FATAL_ERROR
        "Requested git ref \"1d984a2c9143e2617ff1ffa9d86c51e07dc6321e\" is not present locally, and not "
...
if(git_update_strategy STREQUAL "CHECKOUT")
  ...
  if(error_code)
    ...
    if(NOT git_update_strategy STREQUAL "REBASE_CHECKOUT")
      ...
      message(FATAL_ERROR "\nFailed to rebase in: '/home/blvksh33p/Desktop/CFDtool/CFDtool/SlicerCustomAppUtilities'."
...
if(need_stash)
  ...
  if(error_code)
    ...
    if(error_code)
      ...
      message(FATAL_ERROR "\nFailed to unstash changes in: '/home/blvksh33p/Desktop/CFDtool/CFDtool/SlicerCustomAppUtilities'."
                          "\nYou will have to resolve the conflicts manually")
    endif()
  endif()
endif()
