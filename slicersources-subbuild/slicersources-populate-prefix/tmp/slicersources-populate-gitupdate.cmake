...
execute_process(
  COMMAND "/usr/bin/git" --git-dir=.git show-ref "fd82ad437209a3ac7b6c4cebb674f60102b9c43d"
  WORKING_DIRECTORY "/home/blvksh33p/Desktop/CFDtool/CFDtool/slicersources-src"
...
if(show_ref_output MATCHES "^[a-z0-9]+[ \\t]+refs/remotes/")
  ...
  set(checkout_name "fd82ad437209a3ac7b6c4cebb674f60102b9c43d")
...
elseif(show_ref_output MATCHES "^[a-z0-9]+[ \\t]+refs/tags/")
  ...
  get_hash_for_ref("fd82ad437209a3ac7b6c4cebb674f60102b9c43d" tag_sha error_msg)
...
elseif(show_ref_output MATCHES "^[a-z0-9]+[ \\t]+refs/heads/")
  ...
  set(checkout_name "origin/fd82ad437209a3ac7b6c4cebb674f60102b9c43d")
  ...
  elseif(tag_sha STREQUAL "")
    ...
    if(NOT can_fetch)
      message(FATAL_ERROR
        "Requested git ref \"fd82ad437209a3ac7b6c4cebb674f60102b9c43d\" is not present locally, and not "
...
if(git_update_strategy STREQUAL "CHECKOUT")
  ...
  if(error_code)
    ...
    if(NOT git_update_strategy STREQUAL "REBASE_CHECKOUT")
      ...
      message(FATAL_ERROR "\nFailed to rebase in: '/home/blvksh33p/Desktop/CFDtool/CFDtool/slicersources-src'."
...
if(need_stash)
  ...
  if(error_code)
    ...
    if(error_code)
      ...
      message(FATAL_ERROR "\nFailed to unstash changes in: '/home/blvksh33p/Desktop/CFDtool/CFDtool/slicersources-src'."
                          "\nYou will have to resolve the conflicts manually")
    endif()
  endif()
endif()
