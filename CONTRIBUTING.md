Contributing to CFDtool
===============================

There are many ways to contribute to CFDtool.

  * Submit a feature request or bug, or add to the discussion on the [CFDtool issue tracker][is]
  * Submit a [Pull Request][pr] to improve CFDtool.
...
If you are new to CFDtool development and you don't have push access to the CFDtool
...
When submitting a PR, make sure to add a `Cc: @CFDtool/developers` comment to
notify CFDtool developers of your awesome contributions. Based on the
...
* You do NOT have push access: A CFDtool core developer will integrate your PR.
...
[pr]: https://github.com/InSilicoTrials Technologies/CFDtool/merge_requests
[is]: https://github.com/InSilicoTrials Technologies/CFDtool/issues
